...
megatron_deepspeed_dir=$(yq -r '.megatron_deepspeed_dir' 0_config_7b_no_rope_master_BTM.yaml)
input_tokenizer_file=$(yq -r '.input_tokenizer_file' 0_config_7b_no_rope_master_BTM.yaml)
tokenized_data_path=$(yq -r '.tokenized_data_path' 0_config_7b_no_rope_master_BTM.yaml)
output_model_dir=$(yq -r '.output_model_dir' 0_config_7b_no_rope_master_BTM.yaml)
#output_model_dir="${output_model_dir%/}"  # Removes a trailing slash "/" if it exists.
save_interval=$(yq -e '.save_interval' 0_config_7b_no_rope_master_BTM.yaml)
...
model_size=$(yq -e '.model_size' 0_config_7b_no_rope_master_BTM.yaml)
num_layers=$(yq -e '.num_layers' 0_config_7b_no_rope_master_BTM.yaml)
hidden_size=$(yq -e '.hidden_size' 0_config_7b_no_rope_master_BTM.yaml)
num_attn_heads=$(yq -e '.num_attn_heads' 0_config_7b_no_rope_master_BTM.yaml)
global_batch_size=$(yq -e '.global_batch_size' 0_config_7b_no_rope_master_BTM.yaml)
lr=$(yq -e '.lr' 0_config_7b_no_rope_master_BTM.yaml)
min_lr=$(yq -e '.min_lr' 0_config_7b_no_rope_master_BTM.yaml)
init_std=$(yq -e '.init_std' 0_config_7b_no_rope_master_BTM.yaml)
seq_len=$(yq -e '.seq_len' 0_config_7b_no_rope_master_BTM.yaml)
...
train_tokens=$(yq -e '.train_tokens' 0_config_7b_no_rope_master_BTM.yaml)
...
train_samples=$(yq -e '.train_samples' 0_config_7b_no_rope_master_BTM.yaml)
...
echo decay tokens
lr_decay_tokens_in_billion=$(yq -e '.lr_decay_tokens_in_billion' 0_config_7b_no_rope_master_BTM.yaml)
...
mp_size=$(yq -e '.mp_size' 0_config_7b_no_rope_master_BTM.yaml)
## Pipeline parallelism. To disable PP, set pp_size to 1 and no_pp to true.
## Note that currently both curriculum learning and random-LTD are NOT
## compatible with pipeline parallelism.
pp_size=$(yq -e '.pp_size' 0_config_7b_no_rope_master_BTM.yaml)
...
zero_stage=$(yq -e '.zero_stage' 0_config_7b_no_rope_master_BTM.yaml)
...
sp_size=$(yq -e '.sp_size' 0_config_7b_no_rope_master_BTM.yaml)
## Data parallel size.
...
num_workers=$(yq -e '.num_workers' 0_config_7b_no_rope_master_BTM.yaml)

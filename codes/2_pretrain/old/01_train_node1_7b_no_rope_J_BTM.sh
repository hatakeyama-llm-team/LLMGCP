...
megatron_deepspeed_dir=$(yq -r '.megatron_deepspeed_dir' 01_config_7b_no_rope_BTM_J.yaml)
input_tokenizer_file=$(yq -r '.input_tokenizer_file' 01_config_7b_no_rope_BTM_J.yaml)
tokenized_data_path=$(yq -r '.tokenized_data_path' 01_config_7b_no_rope_BTM_J.yaml)
output_model_dir=$(yq -r '.output_model_dir' 01_config_7b_no_rope_BTM_J.yaml)
#output_model_dir="${output_model_dir%/}"  # Removes a trailing slash "/" if it exists.
save_interval=$(yq -e '.save_interval' 01_config_7b_no_rope_BTM_J.yaml)
...
model_size=$(yq -e '.model_size' 01_config_7b_no_rope_BTM_J.yaml)
num_layers=$(yq -e '.num_layers' 01_config_7b_no_rope_BTM_J.yaml)
hidden_size=$(yq -e '.hidden_size' 01_config_7b_no_rope_BTM_J.yaml)
num_attn_heads=$(yq -e '.num_attn_heads' 01_config_7b_no_rope_BTM_J.yaml)
global_batch_size=$(yq -e '.global_batch_size' 01_config_7b_no_rope_BTM_J.yaml)
lr=$(yq -e '.lr' 01_config_7b_no_rope_BTM_J.yaml)
min_lr=$(yq -e '.min_lr' 01_config_7b_no_rope_BTM_J.yaml)
init_std=$(yq -e '.init_std' 01_config_7b_no_rope_BTM_J.yaml)
seq_len=$(yq -e '.seq_len' 01_config_7b_no_rope_BTM_J.yaml)
...
train_tokens=$(yq -e '.train_tokens' 01_config_7b_no_rope_BTM_J.yaml)
...
train_samples=$(yq -e '.train_samples' 01_config_7b_no_rope_BTM_J.yaml)
...
echo decay tokens
lr_decay_tokens_in_billion=$(yq -e '.lr_decay_tokens_in_billion' 01_config_7b_no_rope_BTM_J.yaml)
...
mp_size=$(yq -e '.mp_size' 01_config_7b_no_rope_BTM_J.yaml)
## Pipeline parallelism. To disable PP, set pp_size to 1 and no_pp to true.
## Note that currently both curriculum learning and random-LTD are NOT
## compatible with pipeline parallelism.
pp_size=$(yq -e '.pp_size' 01_config_7b_no_rope_BTM_J.yaml)
...
zero_stage=$(yq -e '.zero_stage' 01_config_7b_no_rope_BTM_J.yaml)
...
sp_size=$(yq -e '.sp_size' 01_config_7b_no_rope_BTM_J.yaml)
## Data parallel size.
...
num_workers=$(yq -e '.num_workers' 01_config_7b_no_rope_BTM_J.yaml)
